                        ...
                        <form action="" method="get">
							<div class="card-header">
                                <div class="card-heading">
                                    <button type="button" onclick="window.location.href='{{ route('products.product_ratings') }}'" class="btn btn-default btn-sm">
                                        Reset
                                    </button>
                                </div>
...
<script>
    ...
    function changeStatus(status,id){
        if (confirm("Are you sure. you want to aprrove rating")) {
            $.ajax({
				...
				success: function(response){
					window.location.href="{{ route('products.product_ratings') }}";
				}	
		   });
        }
