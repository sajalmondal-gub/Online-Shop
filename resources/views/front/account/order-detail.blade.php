                                ...
                                <div class="card-body bg-light mb-3">
                                    <div class="row">
                                            ...
                                            <p class="mb-lg-0 fs-sm fw-bold">
                                                <time datetime="2019-10-01">
                                                   @if(!empty($order->phone))
                                                    {{ \Carbon\Carbon::parse($order->phone)->format('d M,Y') }}
                                                   @else
                                                   N/A
                                                   @endif
                                                </time>
                                        ...
                                        <div class="col-6 col-lg-3">
                                            ...
                                            <!-- Text -->
                                            <p class="mb-0 fs-sm fw-bold">
                                           TK. {{ number_format($order->grand_total,2) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="mb-4 fs-sm fw-bold">
                                                ...
                                                <span class="text-muted">TK.{{ $orderItem->total }}</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="card-body">
                            ...
                            <ul>
                                <li class="list-group-item d-flex">
                                    <span>Subtotal</span>
                                    <span class="ms-auto">{{number_format( $order->subtotal,2) }}Tk.</span>
                                </li>
                                <li class="list-group-item d-flex">
                                <span>Discount {{ (!empty($order->coupon_code)) ? '(' . $order->coupon_code . ')' : '' }}</span>
                                    <span class="ms-auto">{{number_format( $order->discount,2) }}Tk.</span>
                                </li>
                                <li class="list-group-item d-flex">
                                    <span>Shipping</span>
                                    <span class="ms-auto">{{number_format( $order->shipping,2) }}TK.</span>
                                </li>
                                <li class="list-group-item d-flex fs-lg fw-bold">
                                    <span>Total</span>
                                    <span class="ms-auto">{{number_format( $order->grand_total,2) }}Tk.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
