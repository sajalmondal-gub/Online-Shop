                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card cart-summery">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between pb-2">
                                    <div class="h6">{{ $item->name }}. Qty: {{ $item->qty }}</div>
                                ...
                                <div class="d-flex justify-content-between summery-end">
                                    ...
                                    <div class="h6"><strong id="discount_value">TK.{{ $discount }}</strong></div>
                                </div>
                        ...
                        <div class="input-group apply-coupan mt-4">
                             <input type="text" placeholder="Coupon Code" id="discount_code" name="discount_code"class="form-control">
                         ...
                         @if(Session::has('code'))
                         <div class="mt-4" id="discount_remove">
                        ...
                        <h3 class="card-title h5 mb-3">Payment Method</h3>    
                            <div class="">
                                ...
                                <label for="payment_method_one" class="form-check-label">Cash on Dalivery</label>
                            </div> 
                            <div class="">
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.status==true){
                $("#shippingAmount").html(response.shippingCharge);
                $("#grandTotal").html(response.grandTotal);
                $("#discount_value").html('Tk.'+response.discount);
                $("#discount_code").val('');
            }else{
                $("#display_message").html("<span class='text-danger'>"+response.message+"</span>");
